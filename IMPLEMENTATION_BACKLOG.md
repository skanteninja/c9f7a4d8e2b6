...
- Kept the class-town images at page level so Perion, Henesys, and Ellinia remain visible around cards without reducing card readability.
- Release token: 0.10.12-royal-beveled-cards.
...
Follow-up: isolate the Verify Live headless browser assertion that still fails on both attempts even though the deployed build and live browser interaction checks pass.
...
## 0.10.11 completed — verified reference-fidelity correction
...
- Release token: `0.10.11-royal-card-parity`.
- Source `0b69ee5b96f20c2f996238e9d082b7f8ed15682f` generated site `71a81fe402167779602e0580fbe89342336c8dd9`; live browser visual QA and all release gates passed, including Verify Live `35233212343` after rerunning its transient CDP failure.
