...
function patchHtml(raw) {
  ...
  html = html.replace(/\s*<div class="nav-section-label">META<\/div>\s*/, '\n');
...
const app = patchApp(readChunks('app', 4));
const visualCss = fs.readFileSync(path.join(source, 'visuals.css'), 'utf8');
const visuals = ownedUrls(fs.readFileSync(path.join(source, 'visuals.js'), 'utf8'));
const visualDbCss = fs.readFileSync(path.join(source, 'visuals-db.css'), 'utf8');
const visualDb = ownedUrls(fs.readFileSync(path.join(source, 'visuals-db.js'), 'utf8'));
const visualNpcCss = fs.readFileSync(path.join(source, 'visuals-npc.css'), 'utf8');
const visualNpc = ownedUrls(fs.readFileSync(path.join(source, 'visuals-npc.js'), 'utf8'));
const visualSkillCss = fs.readFileSync(path.join(source, 'visuals-skills.css'), 'utf8');
const visualSkill = ownedUrls(fs.readFileSync(path.join(source, 'visuals-skills.js'), 'utf8'));
const visualPortalCss = fs.readFileSync(path.join(source, 'visuals-portals.css'), 'utf8');
const visualPortal = ownedUrls(fs.readFileSync(path.join(source, 'visuals-portals.js'), 'utf8'));
const dashboardPolishCss = fs.readFileSync(path.join(source, 'dashboard-polish.css'), 'utf8');
const dashboardPolish = ownedUrls(fs.readFileSync(path.join(source, 'dashboard-polish.js'), 'utf8'));
const progressionSyncCss = fs.readFileSync(path.join(source, 'progression-sync.css'), 'utf8');
const progressionSync = ownedUrls(fs.readFileSync(path.join(source, 'progression-sync.js'), 'utf8'));
